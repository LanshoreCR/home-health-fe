...
export const ENDPOINTS = {
  ...
  GET_ALL_BANNERS: '/api/Banners/RetrieveAllBanners',
  CREATE_BANNER: '/api/Banners/CreateBanner',
  UPDATE_BANNER_STATUS: '/api/Banners/UpdateBannerStatus',
  CREATE_TOOLS: '/api/Tools/CreateAuditTools',
  GET_BANNER_BY_PACKAGE_ID: '/api/Banners/GetBannerBasedOnPackageID',
  GET_TOOLS_BY_PACKAGE_ID: '/api/Tools/GetAuditTools',
  GET_LOCATIONS_BY_PACKAGE_ID: '/api/Banners/GetBannerLocations',
